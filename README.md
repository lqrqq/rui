...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/lqrqq/rui) 
...
* 端口：443
* 默认UUID：db3f3fac-10ae-11ed-861d-0242ac120002
* vmess额外id：0
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 伪装域名：xxx.workers.dev(CF Workers反代地址)
* 路径：/db3f3fac-10ae-11ed-861d-0242ac120002-vless // 默认vless使用(/自定义UUID码-vless)，vmess使用(/自定义UUID码-vmess)
* 底层传输安全：tls
* 跳过证书验证：false
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "db3f3fac-10ae-11ed-861d-0242ac120002"
    ],
    "websocket": {
        "enabled": true,
        "path": "/db3f3fac-10ae-11ed-861d-0242ac120002-trojan",
...
* 端口: 443
* 密码：db3f3fac-10ae-11ed-861d-0242ac120002
* 加密：chacha20-ietf-poly1305
* 插件程序：xray-plugin_windows_amd64.exe  //需将插件https://github.com/shadowsocks/xray-plugin/releases下载解压后放至shadowsocks同目录
* 插件选项: tls;host=xxx.herokuapp.com;path=/db3f3fac-10ae-11ed-861d-0242ac120002-ss
```
</details>
